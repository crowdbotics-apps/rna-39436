"""
Django settings for rna_39436 project.
...
WSGI_APPLICATION = 'rna_39436.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "rna_39436 API",
    "DESCRIPTION": "API documentation for rna_39436 App",
    "VERSION": "v1",
}
